<?php
    ...
    $password = "password";
    $db = "SmartSolar";
    $myquery = "SELECT SUM(Voltage*Current) as Power, Date as Date FROM systemdata_nov WHERE Date in ('2016-11-07', '2016-11-08', '2016-11-09','2016-11-10','2016-11-11','2016-11-12','2016-11-13') GROUP BY Date";
