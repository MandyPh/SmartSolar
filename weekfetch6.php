<?php
    ...
    $password = "password";
    $db = "SmartSolar";
    $myquery = "SELECT SUM(Voltage*Current) as Power, Date as Date FROM systemdata_nov WHERE Date in ('2016-11-14', '2016-11-15', '2016-11-16','2016-11-17','2016-11-18','2016-11-19','2016-11-20') GROUP BY Date";
